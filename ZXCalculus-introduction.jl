...
This project is for GSoC 2020. Mentored by [Roger Luo](https://github.com/Roger-luo).
...
md"## Benchmarks
We tested the phase teleportation algorithm on 40 circuits with ZXCalculus.jl and PyZX. The benchmark results shown that ZXCalculus.jl has 8x-50x speed-up.
